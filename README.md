...
The project will open at http://localhost:5500

No npm install or build step is required for the frontend. All dependencies load from CDN.

Pages and Navigation
PageFileDescriptionHomeindex.htmlMain landing pageLoginlogin.htmlRole-based authenticationBuyer Dashboardbuyer.htmlCrop browsing and purchasingPlay and Earngame.htmlPong game with rewards and loans
